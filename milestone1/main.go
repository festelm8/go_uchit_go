...
//a := []string{"kok","world"} // создание среза со строками
...
//func Mm(a,b int) int{ //в скобках указываем получаемые данные, во вторых скобках (или нет если значение одно) тип возвращаемых данных
//	return a+b
//}
